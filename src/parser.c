...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(2)] = {
    ...
    [anon_sym_does] = ACTIONS(15),
    [anon_sym_must] = ACTIONS(15),
  ...
  [STATE(4)] = {
    ...
    [anon_sym_on] = ACTIONS(34),
    [anon_sym_off] = ACTIONS(34),
  ...
  [STATE(7)] = {
    ...
    [anon_sym_has] = ACTIONS(66),
    [anon_sym_does] = ACTIONS(66),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__anything, 1, 0, 0),
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__anything, 1, 0, 0),
  ...
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, 0, 1),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 2, 0, 1),
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_multi, 2, 0, 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_multi, 2, 0, 1),
  ...
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [121] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [124] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [127] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 2, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 2, 0, 0),
